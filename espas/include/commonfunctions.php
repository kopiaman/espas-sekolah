...
function checkTableName($shortTName, $type=false)
{
	...
	if ("user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("bill_record" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("bill_item" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("job" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Alumni_List" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	...
	if ("all" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("setting_no_room" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("create_pbsra" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("staff_move" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("student_attendance" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("attend_creator" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("student_course" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("aset" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("staff_valuation" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("staff_qualification" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("staff_absent_late" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("staff_late" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("attend_creator_staff" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Student_Darjah" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("exam_rank_kelas" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("w_news" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("enroll" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("enroll_apply" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("w_gallery" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("w_gallery_sub" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("exam_rank_darjah" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("exam_grade_result" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("w_slider" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("w_about" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("student_upsra" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("exam_slip_darjah" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("billing_collection_permurid" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("bill_record");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="bill_record";
	}
	$strPerm = GetUserPermissions("bill_item");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="bill_item";
	}
	...
	$strPerm = GetUserPermissions("Alumni List");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Alumni List";
	}
	...
	$strPerm = GetUserPermissions("setting_no_room");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="setting_no_room";
	}
	$strPerm = GetUserPermissions("create_pbsra");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="create_pbsra";
	}
	$strPerm = GetUserPermissions("staff_move");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="staff_move";
	}
	$strPerm = GetUserPermissions("student_attendance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="student_attendance";
	}
	$strPerm = GetUserPermissions("attend_creator");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="attend_creator";
	}
	...
	$strPerm = GetUserPermissions("aset");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="aset";
	}
	$strPerm = GetUserPermissions("staff_valuation");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="staff_valuation";
	}
	...
	$strPerm = GetUserPermissions("staff_absent_late");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="staff_absent_late";
	}
	$strPerm = GetUserPermissions("staff_late");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="staff_late";
	}
	$strPerm = GetUserPermissions("attend_creator_staff");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="attend_creator_staff";
	}
	$strPerm = GetUserPermissions("Student_Darjah");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Student_Darjah";
	}
	$strPerm = GetUserPermissions("exam_rank_kelas");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="exam_rank_kelas";
	}
	...
	$strPerm = GetUserPermissions("enroll_apply");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="enroll_apply";
	}
	...
	$strPerm = GetUserPermissions("exam_rank_darjah");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="exam_rank_darjah";
	}
	$strPerm = GetUserPermissions("exam_grade_result");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="exam_grade_result";
	}
	...
	$strPerm = GetUserPermissions("w_about");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="w_about";
	}
	$strPerm = GetUserPermissions("student_upsra");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="student_upsra";
	}
	$strPerm = GetUserPermissions("exam_slip_darjah");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="exam_slip_darjah";
	}
	$strPerm = GetUserPermissions("billing_collection_permurid");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="billing_collection_permurid";
	}
...
function ReadUserPermissions($userID="")
{
	...
	if($userID!="Guest")
	{
			...
			$sql = "select `GroupID`, `UserName` from `user_ugmembers` where `UserName`=".db_prepare_string($userID);
		else
			$sql = "select `GroupID`, `UserName` from `user_ugmembers` where `UserName`=".strtoupper(db_prepare_string($userID));
		$rs = db_query($sql,$conn);
	...
	$rights=array();
	$sql = "select `TableName`,`AccessMask` from `user_ugrights` where `GroupID` in (".$groupstr.")";
	$rs = db_query($sql,$conn);
	while($data=db_fetch_numarray($rs))
	{
...
{	
	...
	if(array_key_exists("user",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("bill_record",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("bill_item",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("job",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Alumni List",$_SESSION["UserRights"]["Guest"]))
		return true;
	...
	if(array_key_exists("all",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("setting_no_room",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("create_pbsra",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("staff_move",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("student_attendance",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("attend_creator",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("student_course",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("aset",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("staff_valuation",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("staff_qualification",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("staff_absent_late",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("staff_late",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("attend_creator_staff",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Student_Darjah",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("exam_rank_kelas",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("w_news",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("enroll",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("enroll_apply",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("w_gallery",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("w_gallery_sub",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("exam_rank_darjah",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("exam_grade_result",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("w_slider",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("w_about",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("student_upsra",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("exam_slip_darjah",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("billing_collection_permurid",$_SESSION["UserRights"]["Guest"]))
		return true;
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password)
{
	global $globalEvents;
		...
		$_SESSION["_student_info_OwnerID"] = $data["icNo"];
			...
			$_SESSION["_Alumni List_OwnerID"] = $data["icNo"];
			...
			$_SESSION["_Student_Darjah_OwnerID"] = $data["icNo"];
			$_SESSION["_exam_rank_kelas_OwnerID"] = $data["icNo"];
			$_SESSION["_exam_rank_darjah_OwnerID"] = $data["icNo"];
			$_SESSION["_exam_grade_result_OwnerID"] = $data["icNo"];
			$_SESSION["_exam_slip_darjah_OwnerID"] = $data["icNo"];
