<?php 
class eventclass_Report_Billing_Pending  extends eventsBase
{ 
	function eventclass_Report_Billing_Pending()
	{
	// fill list of events
...
$strSQLExists = "select CourseID,Sem from program_course where ProgramID='$programID'";
...
$sem=$data['Sem'];
$strSQLInsert = "insert into student_course (StudentID, CourseID, Sem) values ('$studentID', '$course', '$sem')";
...
$strSQLInsert2 = "insert into student_program_bill (program_bill_item_id, studentID, status, date,amount_bill,amount_balance) values ('$programBillingItemID', '$studentID', 'Pending','$dateNow','$amountbill','$amountbill')";
