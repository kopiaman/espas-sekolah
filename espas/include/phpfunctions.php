...
function edit_error_handler($errno, $errstr, $errfile, $errline)
{
	...
	if ( $inlineedit ) 
		$message=""."Rekod TIDAK teredit".". ".$errstr;
	else  
		$message="<<< "."Rekod TIDAK teredit"." >>><br><br>".$errstr;
	$readevalues=true;
	$error_happened=true;
}
...
function add_error_handler($errno, $errstr, $errfile, $errline)
{
	...
	if ( $inlineadd!=ADD_SIMPLE ) 
		$message=""."Rekod TIDAK tertambah".". ".$errstr;
	else  
		$message="<<< "."Rekod TIDAK tertambah"." >>><br><br>".$errstr;
	$readavalues=true;
	$error_happened=true;
}
...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="student_info" && $field=="Option")
	{
		$value="";;
		return $value;
	}	
				if($table=="bill_record" && $field=="sstatus")
	{
		global $conn;

if($data['sstatus']==1){
$value='<font color=red>Selesai </font> ';
}else{ 
$value='<font color=green>Belum Proses</font>'; };
;
		return $value;
	}	
				if($table=="bill_item" && $field=="amount")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="Report-Billing Pending" && $field=="Bill")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="Report-Billing Pending" && $field=="Paid")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="Report-Billing Pending" && $field=="Outstanding")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="student_payment" && $field=="amount")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="student_payment" && $field=="option")
	{
		
$sid=$data['sid'];
$payid=$data['pay_id'];
$resitID=$sid.$payid;
$value="<span>$resitID</span>";;
		return $value;
	}	
				if($table=="student_billing" && $field=="amount")
	{
		$value="RM".number_format($value,2);;
		return $value;
	}	
				if($table=="student_billing" && $field=="cetak")
	{
		$value="";;
		return $value;
	}	
				if($table=="student_billing" && $field=="sstatus")
	{
		$status=$data['sstatus'];
if($status=="Tertunggak"){
$value ="<font color ='red'>$status</font>";
}else if($status="Dibayar"){ $value ="<font color ='green'><strong>$status</strong></font>";
}else{ $value ="<font color ='red'>$status</font>";};;
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="Option")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=1' target='_blank'>1</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s2")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=2' target='_blank'>2</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s3")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=3' target='_blank'>3</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s4")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=4' target='_blank'>4</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s5")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=5' target='_blank'>5</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s6")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=6' target='_blank'>6</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s7")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=7' target='_blank'>7</a>";
		return $value;
	}	
				if($table=="Report_Exam_Slip_Indiv" && $field=="s8")
	{
		$value="<a href='x_examslip_individual.php?StudentID=$data[StudentID]&&Semester=8' target='_blank'>8</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="Option")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=1' target='_blank'>1</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s2")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=2' target='_blank'>2</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s3")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=3' target='_blank'>3</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s4")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=4' target='_blank'>4</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s5")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=5' target='_blank'>5</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s6")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=6' target='_blank'>6</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s7")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=7' target='_blank'>7</a>";
		return $value;
	}	
				if($table=="Report_Exam_Result_Indiv" && $field=="s8")
	{
		$value="<a href='x_exam_result.php?StudentID=$data[StudentID]&&Semester=8' target='_blank'>8</a>";
		return $value;
	}	
				if($table=="create_pbsra" && $field=="Option")
	{
		$value="";;
		return $value;
	}	
				if($table=="exam_rank_kelas" && $field=="opt")
	{
		
$darjah=$data['darjah'];
$etype='UP1';
$kelas=$data['kelas'];
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
	}	
				if($table=="exam_rank_kelas" && $field=="ppt")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_kelas" && $field=="up2")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_kelas" && $field=="pat")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_darjah" && $field=="opt")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_darjah" && $field=="ppt")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_darjah" && $field=="up2")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_rank_darjah" && $field=="pat")
	{
...
$value="<span><a href='x_exam_ranking.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_slip_darjah" && $field=="opt")
	{
		
$darjah=$data['darjah'];
$etype='UP1';
$kelas='';
$value="<span><a href='x_exam_slip2.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
	}	
				if($table=="exam_slip_darjah" && $field=="ppt")
	{
...
$value="<span><a href='x_exam_slip2.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_slip_darjah" && $field=="up2")
	{
...
$value="<span><a href='x_exam_slip2.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="exam_slip_darjah" && $field=="pat")
	{
...
$value="<span><a href='x_exam_slip2.php?kelas=$kelas&darjah=$darjah&etype=$etype' target='_blank'> $etype </a></span>";
		return $value;
				...
				if($table=="billing_collection_permurid" && $field=="opt")
	{
		
$StudentID=$data['StudentID'];
$value="<span><a href='x_bill_statement.php?StudentID=$StudentID' target='_blank'> PENYATA </a></span>"
;
		return $value;
	}	
...
function fileCustomExpression($file, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="student_info" && $field=="photo")
	{
		;
		return $value;
	}	
				if($table=="staff_info" && $field=="photo")
	{
		;
		return $value;
	}	
				if($table=="Alumni List" && $field=="photo")
	{
		;
		return $value;
	}	
				if($table=="w_news" && $field=="attach")
	{
		;
		return $value;
	}	
				if($table=="enroll" && $field=="at_photo")
	{
		;
		return $value;
	}	
				if($table=="enroll_apply" && $field=="at_photo")
	{
		;
		return $value;
	}	
				if($table=="w_slider" && $field=="picture")
	{
		;
		return $value;
	}	
				if($table=="w_about" && $field=="pic")
	{
		;
		return $value;
	}	
				if($table=="w_about" && $field=="attach")
	{
		;
		return $value;
	}	
				if($table=="w_pic" && $field=="files")
	{
		;
		return $value;
	}	
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table) 
		$table = $strTableName;
				if($table=="student_info" && $field=="Status" && $ptype=="edit")
	{
		return "Class=5";
	}
				if($table=="student_info" && $field=="Status" && $ptype=="add")
	{
		return "Class=5";
	}
				if($table=="student_info" && $field=="Status" && $ptype=="search")
	{
		return "Class=5";
	}
				if($table=="student_info" && $field=="tahun")
	{
		return "Class=45";
	}
				if($table=="staff_info" && $field=="f1_relation")
	{
		return "Class='9'";
	}
				if($table=="staff_info" && $field=="f2_relation")
	{
		return "Class='9'";
	}
				if($table=="staff_info" && $field=="Elaun")
	{
		return "Class=47";
	}
				if($table=="staff_info" && $field=="Race")
	{
		return "Class=3";
	}
				if($table=="campus_setting" && $field=="state")
	{
		return "class=1";
	}
				if($table=="campus_setting" && $field=="sek_jenis")
	{
		return "Class=58";
	}
				if($table=="Alumni List" && $field=="StateID")
	{
		return "Class=1";
	}
				if($table=="Alumni List" && $field=="Status")
	{
		return "Class=5";
	}
				if($table=="Alumni List" && $field=="race")
	{
		return "Class=3";
	}
				if($table=="student_payment" && $field=="terms")
	{
		return "Class=29";
	}
				if($table=="Report_Family" && $field=="relation1")
	{
		return "Class=9";
	}
				if($table=="Report_Family" && $field=="relation2")
	{
		return "Class=9";
	}
				if($table=="Report_Family" && $field=="Status")
	{
		return "Class=5";
	}
				if($table=="Report_Discipline" && $field=="Level")
	{
		return "Class=14";
	}
				if($table=="Report_Discipline" && $field=="Action_Taken")
	{
		return "Class=15";
	}
				if($table=="Report_Discipline" && $field=="Status")
	{
		return "Class=5";
	}
				if($table=="Report_Extracurricular" && $field=="Level")
	{
		return "Class=34";
	}
				if($table=="Report_Extracurricular" && $field=="Status")
	{
		return "Class=5";
	}
				if($table=="Report_Staff_Kin" && $field=="f1_relation")
	{
		return "Class='9'";
	}
				if($table=="Report_Staff_Kin" && $field=="f2_relation")
	{
		return "Class='9'";
	}
				if($table=="Chart_no_student" && $field=="StateID")
	{
		return "Class=1";
	}
				if($table=="create_pbsra" && $field=="pmonth")
	{
		return "Class=51";
	}
				if($table=="staff_move" && $field=="reason")
	{
		return "Class=49";
	}
				if($table=="student_attendance" && $field=="amonth")
	{
		return "Class=51";
	}
				if($table=="student_course" && $field=="etype")
	{
		return "Class=52";
	}
				if($table=="staff_qualification" && $field=="EducationType")
	{
		return "Class=2";
	}
				if($table=="staff_absent_late" && $field=="StaffID")
	{
		return "sstatus='Aktif'";
	}
				if($table=="staff_absent_late" && $field=="bulan")
	{
		return "Class=51";
	}
				if($table=="staff_absent_late" && $field=="reason")
	{
		return "Class=56";
	}
				if($table=="staff_late" && $field=="StaffID")
	{
		return "sstatus='Aktif'";
	}
				if($table=="staff_late" && $field=="bulan")
	{
		return "Class=51";
	}
				if($table=="w_news" && $field=="category")
	{
		return "Class=57";
	}
				if($table=="exam_grade_result" && $field=="murid")
	{
		return "Status='Aktif'";
	}
				if($table=="exam_grade_result" && $field=="etype")
	{
		return "Class=52";
	}
	return "";
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="student_info" && $field=="Status" && $ptype=="search") 
	{
		return "Aktif";
				...
				if($table=="student_info" && $field=="sesi") 
	{
		return "Pagi";
	}
				if($table=="staff_info" && $field=="sstatus") 
	{
		return "Aktif";
	}
				if($table=="bill_record" && $field=="bill_date") 
	{
		return Now();
	}
				if($table=="Alumni List" && $field=="Disability") 
	{
		return "No";
	}
				if($table=="Alumni List" && $field=="race") 
	{
		return "Malay";
				...
				if($table=="student_payment" && $field=="pay_date") 
	{
		return now();
	}
				if($table=="student_payment" && $field=="terms") 
	{
		return "Tunai";
				...
				if($table=="staff_absent_late" && $field=="abdate") 
	{
		return Now();
	}
				if($table=="staff_late" && $field=="abdate") 
	{
		return Now();
	}
				if($table=="Student_Darjah" && $field=="sesi") 
	{
		return "Pagi";
	}
				if($table=="exam_rank_kelas" && $field=="sesi") 
	{
		return "Pagi";
	}
				if($table=="w_news" && $field=="nstatus") 
	{
		return "On";
	}
				if($table=="enroll" && $field=="Date_Apply") 
	{
		return now();
	}
				if($table=="enroll_apply" && $field=="Date_Apply") 
	{
		return now();
	}
				if($table=="enroll_apply" && $field=="Status") 
	{
		return "Belum Diproses";
	}
				if($table=="exam_rank_darjah" && $field=="sesi") 
	{
		return "Pagi";
	}
				if($table=="w_slider" && $field=="sstatus") 
	{
		return "On";
	}
				if($table=="w_about" && $field=="category") 
	{
		return "Profil";
	}
				if($table=="w_about" && $field=="nstatus") 
	{
		return "On";
	}
				if($table=="exam_slip_darjah" && $field=="sesi") 
	{
		return "Pagi";
	}
	return "";
