...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="setting_no_room")
		{
			return false;
		}
		if($table=="create_pbsra")
		{
			return false;
		}
		if($table=="staff_move")
		...
		if($table=="attend_creator_staff")
		{
			return false;
		}
		if($table=="Student_Darjah")
		{
			return false;
		}
		if($table=="exam_rank_kelas")
		{
			return false;
		}
		if($table=="w_news")
		...
		if($table=="exam_rank_darjah")
		{
			return false;
		}
		if($table=="exam_grade_result")
		{
			return false;
		}
		if($table=="w_slider")
		...
		if($table=="student_upsra")
		{
			return false;
		}
		if($table=="exam_slip_darjah")
		{
			return false;
		}
		if($table=="billing_collection_permurid")
		{
			return false;
		}
