...
include_once("include/staff_valuation_settings.php");
include_once("include/staff_qualification_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["staff_info_list"] = $layout;
