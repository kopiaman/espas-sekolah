<?php
/**
 * Exam Slip Generator: Batch processing
 *
 * Author: Zon Hisham Z.Abidin <zonhisham@gmail.com>
 * Date written:  14/4/2013
        ...
        if ($studnum == 0) {
          ...
          while ($index < $studnum) {
            if ($index > 0) {
              ...
              $header = common_slip_header(1,$preview,$generate,"EXAMINATION RESULT SLIP","MF-03-01 Rev.1","01-Dec-10");
              print $header;
            }
            ...
            <table width="80%" border=1>
              ...
              <?php
                ...
                $sqlout = "select course.name,
                                  ...
                                  where student_course.studentid=".$stud[$index]['id'].
                                  " and student_course.programid=".$stud[$index]['pid'];
                                  //note: semester clause omitted as we want to accumulate result for ALL semesters
