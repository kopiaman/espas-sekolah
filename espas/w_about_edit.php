...
$layout->blocks["top"][] = "details";$page_layouts["w_about_edit"] = $layout;
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: w_about_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: w_about_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
//	show readonly fields
	$pageObject->readOnlyFields["category"] = htmlspecialchars($pageObject->showDBValue("category", $data));
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='w_about_view.php?".$viewlink."'\"");
