...
$layout->blocks["top"][] = "details";$page_layouts["Alumni_List_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Personal1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Campus_Info1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Contact1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Next_Of_Kin1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Medical1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["Alumni_List_edit_Development1"] = $layout;
...
$templatefile = "Alumni_List_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Alumni_List_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Alumni_List_view.php?".$viewlink."'\"");
