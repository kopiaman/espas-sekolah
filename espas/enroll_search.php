...
$layout->blocks["top"][] = "search";$page_layouts["enroll_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "enroll_search.htm";
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("Date_Apply"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("Date_Apply")] = GetTableURL($pageObject->pSet->getLookupTable("Date_Apply"));
	
	$pageObject->fillFieldToolTips("Date_Apply");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("Date_Apply");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Date_Apply";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("Date_Apply_label","<label for=\"".GetInputElementId("Date_Apply", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("Date_Apply_label", true);
	
	$xt->assign("Date_Apply_fieldblock", true);
	$xt->assignbyref("Date_Apply_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("Date_Apply_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("Date_Apply_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_Date_Apply", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("Date_Apply");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Date_Apply", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Date_Apply", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("MobileTelephone"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("MobileTelephone")] = GetTableURL($pageObject->pSet->getLookupTable("MobileTelephone"));
	
	$pageObject->fillFieldToolTips("MobileTelephone");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("MobileTelephone");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "MobileTelephone";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("MobileTelephone_label","<label for=\"".GetInputElementId("MobileTelephone", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("MobileTelephone_label", true);
	
	$xt->assign("MobileTelephone_fieldblock", true);
	$xt->assignbyref("MobileTelephone_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("MobileTelephone_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("MobileTelephone_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_MobileTelephone", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("MobileTelephone");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"MobileTelephone", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"MobileTelephone", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
