...
$layout->blocks["top"][] = "details";$page_layouts["setting_edit"] = $layout;
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("Field_Name_label","<label for=\"".GetInputElementId("Field_Name", $id, PAGE_EDIT)."\">","</label>");
