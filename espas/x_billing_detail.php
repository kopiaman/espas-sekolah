...
<body>
 <table width="512" border="0" align="center" class="left">
   <tr>
     ...
     <td width="2%"><br /></td>
     <td width="87%"><strong><?php echo head(); ?></td>
   </tr>
 </table>
 <h1>PENYATA YURAN INDIVIDU</h1>
...
$row_pay=mysql_fetch_assoc($q_pay);
     ...
     <td colspan="5"><br />
       ...
       <table width="100%" border="1" align="center" class="table_grey">
         ...
         <tr>
           <th colspan="4" scope="col">REKOD BAYARAN:</th>
         </tr>
         <tr>
     ...
     <?php do {   ?>
           ...
           <td><?php echo $row_pay['sid'].$row_pay['pay_id']; ?></td>
