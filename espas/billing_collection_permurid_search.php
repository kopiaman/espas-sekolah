...
include("include/billing_collection_permurid_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["billing_collection_permurid_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "billing_collection_permurid_search.htm";
...
$params['shortTableName'] = 'billing_collection_permurid';
