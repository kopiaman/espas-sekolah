...
include("include/Report_Staff_Kin_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["Report_Staff_Kin_export"] = $layout;
...
$xt->display("Report_Staff_Kin_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Report_Staff_Kin.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Staff_Kin.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Staff_Kin.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Report_Staff_Kin.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Staff No").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Jabatan").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("F1 Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Hubungan").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("F1 Tel").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("F2 Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("F2 Relation").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("F2 Tel").'</td>';	
	}
	else
	{
		echo "<td>"."Nama"."</td>";
