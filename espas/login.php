...
$layout = new TLayout("login","Purific1Green1","MobileGreen1");
...
$layout->containers["fields"][] = array("name"=>"mesreg","block"=>"","substyle"=>3);
...
if(@$_GET["message"]=="expired")
	$message = "Sesi anda luput. Sila log-masuk kembali.";
