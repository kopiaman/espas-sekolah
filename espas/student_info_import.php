...
// keys array
$keys[]=AddFieldWrappers("StudentID");
$keys_present=1;
...
$layout = new TLayout("import","Purific1Green1","MobileGreen1");
...
$layout->blocks["top"][] = "import";$page_layouts["student_info_import"] = $layout;
...
$xt->display("student_info_import.htm");
