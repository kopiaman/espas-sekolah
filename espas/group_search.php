...
$layout->blocks["top"][] = "search";$page_layouts["group_search"] = $layout;
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("group"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("group")] = GetTableURL($pageObject->pSet->getLookupTable("group"));
	...
	if(isEnableSection508())
		$xt->assign_section("group_label","<label for=\"".GetInputElementId("group", $id, PAGE_SEARCH)."\">","</label>");
	else 
