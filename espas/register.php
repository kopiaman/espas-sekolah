...
$layout = new TLayout("register","Purific1Green1","MobileGreen1");
...
$layout = new TLayout("register_success","Purific1Green1","MobileGreen1");
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
...
//	check if entered username already exists
	...
	{
		$pageObject->jsSettings['tableSettings'][$strTableName]['regmsg_userError'] = "Nama Pengguna tidak boleh kosong.";
		$allow_registration = false;
	}	
	else
	{
		...
		if($data[0]>0)
		{
			$pageObject->jsSettings['tableSettings'][$strTableName]['regmsg_userError'] = "Nama Pengguna "." <i>".$strUsername."</i> "."sudah wujud. Pilih nama lain.";
			$allow_registration=false;
		}
	}
