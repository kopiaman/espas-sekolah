...
if($inlineadd == ADD_INLINE)
	$templatefile = "Report_Extracurricular_inline_add.htm";
else
	$templatefile = "Report_Extracurricular_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Report_Extracurricular_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Report_Extracurricular_edit.php?'.$keylink.'\'>'."Sunting".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Report_Extracurricular_view.php?'.$keylink.'\'>'."Lihat".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Report_Extracurricular_".$pageObject->getPageType().".php");
