...
add_nocache_headers();
include("include/w_about_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["w_about_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "w_about_inline_add.htm";
else
	$templatefile = "w_about_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: w_about_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'w_about_edit.php?'.$keylink.'\'>'."Sunting".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'w_about_view.php?'.$keylink.'\'>'."Lihat".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: w_about_".$pageObject->getPageType().".php");
...
//	show readonly fields
	$pageObject->readOnlyFields["category"] = htmlspecialchars($pageObject->showDBValue("category", $defvalues));
$linkdata="";
