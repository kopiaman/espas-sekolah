...
include("include/exam_slip_darjah_variables.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["exam_slip_darjah_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "darjah";
				}
