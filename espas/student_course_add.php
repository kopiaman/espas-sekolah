...
if($inlineadd == ADD_INLINE)
	$templatefile = "student_course_inline_add.htm";
else
	$templatefile = "student_course_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: student_course_add.php');
...
//	processing etype - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd==ADD_INLINE;
	if($inlineAddOption)
	{
		$control_etype = $pageObject->getControl("etype", $id);
		$control_etype->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing etype - end
//	processing s1 - start
	$inlineAddOption = true;
	$inlineAddOption = $inlineadd==ADD_INLINE;
	if($inlineAddOption)
	{
		...
		$control_s1->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s1 - end
//	processing s2 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s2->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s2 - end
//	processing s3 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s3->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s3 - end
//	processing s4 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s4->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s4 - end
//	processing s5 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s5->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s5 - end
//	processing s6 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s6->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s6 - end
//	processing s7 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s7->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s7 - end
//	processing s8 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s8->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s8 - end
//	processing s9 - start
	$inlineAddOption = true;
	...
	if($inlineAddOption)
	{
		...
		$control_s9->readWebValue($avalues, $blobfields, "", false, $afilename_values);
	}
//	processing s9 - end
...
//	processing etype - start
			...
			if($inlineAddOption)
			{
				$control_etype->afterSuccessfulSave();
			}
//	processing etype - end
//	processing s1 - start
			$inlineAddOption = true;
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'student_course_edit.php?'.$keylink.'\'>'."Sunting".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'student_course_view.php?'.$keylink.'\'>'."Lihat".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: student_course_".$pageObject->getPageType().".php");
...
if(array_key_exists("copyid1",$_REQUEST) || array_key_exists("editid1",$_REQUEST))
{
	...
	{
		$copykeys["scid"]=postvalue("copyid1");
	}
	else
	{
		$copykeys["scid"]=postvalue("editid1");
	}
