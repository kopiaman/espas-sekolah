...
function GetTableURL($table = "")
{
	...
	if("user" == $table) 
		return "user";
	if("bill_record" == $table) 
		return "bill_record";
	if("bill_item" == $table) 
		return "bill_item";
	if("job" == $table) 
		return "job";
	if("Alumni List" == $table) 
		return "Alumni_List";
	...
	if("all" == $table) 
		return "all";
	if("setting_no_room" == $table) 
		return "setting_no_room";
	if("create_pbsra" == $table) 
		return "create_pbsra";
	if("staff_move" == $table) 
		return "staff_move";
	if("student_attendance" == $table) 
		return "student_attendance";
	if("attend_creator" == $table) 
		return "attend_creator";
	if("student_course" == $table) 
		return "student_course";
	if("aset" == $table) 
		return "aset";
	if("staff_valuation" == $table) 
		return "staff_valuation";
	if("staff_qualification" == $table) 
		return "staff_qualification";
	if("staff_absent_late" == $table) 
		return "staff_absent_late";
	if("staff_late" == $table) 
		return "staff_late";
	if("attend_creator_staff" == $table) 
		return "attend_creator_staff";
	if("Student_Darjah" == $table) 
		return "Student_Darjah";
	if("exam_rank_kelas" == $table) 
		return "exam_rank_kelas";
	if("w_news" == $table) 
		return "w_news";
	if("enroll" == $table) 
		return "enroll";
	if("enroll_apply" == $table) 
		return "enroll_apply";
	if("w_gallery" == $table) 
		return "w_gallery";
	if("w_gallery_sub" == $table) 
		return "w_gallery_sub";
	if("exam_rank_darjah" == $table) 
		return "exam_rank_darjah";
	if("exam_grade_result" == $table) 
		return "exam_grade_result";
	if("w_slider" == $table) 
		return "w_slider";
	if("w_about" == $table) 
		return "w_about";
	if("student_upsra" == $table) 
		return "student_upsra";
	if("exam_slip_darjah" == $table) 
		return "exam_slip_darjah";
	if("billing_collection_permurid" == $table) 
		return "billing_collection_permurid";
...
{	
	...
	if("user" == $shortTName) 
		return "user";
	if("bill_record" == $shortTName) 
		return "bill_record";
	if("bill_item" == $shortTName) 
		return "bill_item";
	if("job" == $shortTName) 
		return "job";
	if("Alumni_List" == $shortTName) 
		return "Alumni List";
	...
	if("all" == $shortTName) 
		return "all";
	if("setting_no_room" == $shortTName) 
		return "setting_no_room";
	if("create_pbsra" == $shortTName) 
		return "create_pbsra";
	if("staff_move" == $shortTName) 
		return "staff_move";
	if("student_attendance" == $shortTName) 
		return "student_attendance";
	if("attend_creator" == $shortTName) 
		return "attend_creator";
	if("student_course" == $shortTName) 
		return "student_course";
	if("aset" == $shortTName) 
		return "aset";
	if("staff_valuation" == $shortTName) 
		return "staff_valuation";
	if("staff_qualification" == $shortTName) 
		return "staff_qualification";
	if("staff_absent_late" == $shortTName) 
		return "staff_absent_late";
	if("staff_late" == $shortTName) 
		return "staff_late";
	if("attend_creator_staff" == $shortTName) 
		return "attend_creator_staff";
	if("Student_Darjah" == $shortTName) 
		return "Student_Darjah";
	if("exam_rank_kelas" == $shortTName) 
		return "exam_rank_kelas";
	if("w_news" == $shortTName) 
		return "w_news";
	if("enroll" == $shortTName) 
		return "enroll";
	if("enroll_apply" == $shortTName) 
		return "enroll_apply";
	if("w_gallery" == $shortTName) 
		return "w_gallery";
	if("w_gallery_sub" == $shortTName) 
		return "w_gallery_sub";
	if("exam_rank_darjah" == $shortTName) 
		return "exam_rank_darjah";
	if("exam_grade_result" == $shortTName) 
		return "exam_grade_result";
	if("w_slider" == $shortTName) 
		return "w_slider";
	if("w_about" == $shortTName) 
		return "w_about";
	if("student_upsra" == $shortTName) 
		return "student_upsra";
	if("exam_slip_darjah" == $shortTName) 
		return "exam_slip_darjah";
	if("billing_collection_permurid" == $shortTName) 
		return "billing_collection_permurid";
