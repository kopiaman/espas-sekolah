...
$templatefile = ($inlineedit == EDIT_INLINE) ? "set_setting_category_inline_edit.htm" : "set_setting_category_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: set_setting_category_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: set_setting_category_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='set_setting_category_view.php?".$viewlink."'\"");
